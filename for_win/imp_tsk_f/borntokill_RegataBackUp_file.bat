...
:: copy 
:: xcopy /E -> copy all dirs,subdirs and files 
...
xcopy /E /Q "D:\KSoft" "D:\Arhiv\Arh_REGATA\REGATA_1_D\Regata1\KSoft\"

ECHO !!! Done-2 - BackUp of Regata 1 - Complete !!!
echo *** Starting BackUp of Regata 2 ***

xcopy /E /Q "E:\KSoft" "D:\Arhiv\Arh_REGATA\REGATA_2_E\Regata2\KSoft\"
