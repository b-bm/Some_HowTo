...
# Then make NEW Regata directories
# some examples:
# New-Item -ItemType directory -Path C:\dir1\newDir
# new-item c:\dir1\newDir -itemtype directory
# new-item c:\dir1\newDir -type directory
# md -Path 'C:\dir1\newDir'
# Aliases : md 

New-Item "D:\Arhiv\Arh_REGATA\REGATA_1_D\Regata1\KSoft" -itemtype directory 
New-Item "D:\Arhiv\Arh_REGATA\REGATA_2_E\Regata2\KSoft" -itemtype directory

# This output some string text
write-host "Tasks of creation NEW Regata Dirs are complete !!!" -foregroundcolor Red -backgroundcolor white
